namespace MoleMole
{
    ...
    public class TheCoolpadAccountManager : TheBaseAccountManager
    {
        ...
        {
            base._accountDelegate = new TheCoolpadAccountDelegate();
        }
        ...
        public override bool Pay(string productID, string productName, float productPrice)
        {
            ...
            {
                base._accountDelegate.pay(productID, productName, productPrice, Guid.NewGuid().ToString("N"), Singleton<PlayerModule>.Instance.playerData.userId.ToString(), Singleton<NetworkManager>.Instance.DispatchSeverData.oaServerUrl + "/callback/coolpad", "AccountEventListener", "PayFinishedCallBack", null);
            }
            return false;
        }
