namespace MoleMole
{
    ...
    public class TheQihooAccountManager : TheBaseAccountManager
    {
        ...
        {
            base._accountDelegate = new TheQihooAccountDelegate();
        }
        ...
        public override bool Pay(string productID, string productName, float productPrice)
        {
            ...
            {
                base._accountDelegate.pay(productID, productName, productPrice, Guid.NewGuid().ToString("N"), Singleton<PlayerModule>.Instance.playerData.userId.ToString(), Singleton<NetworkManager>.Instance.DispatchSeverData.oaServerUrl + "/callback/360", "AccountEventListener", "PayFinishedCallBack", null);
            }
            return false;
        }
