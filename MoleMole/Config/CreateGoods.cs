namespace MoleMole.Config
{
    ...
    public class CreateGoods : ConfigAbilityAction, IHashable
    {
        ...
        {
            HashUtils.ContentHashOnto(this.GoodType, ref lastHash);
            HashUtils.ContentHashOnto(this.GoodAbility, ref lastHash);
            if (this.GoodArgument != null)
            {
                HashUtils.ContentHashOnto(this.GoodArgument.isDynamic, ref lastHash);
                HashUtils.ContentHashOnto(this.GoodArgument.fixedValue, ref lastHash);
                HashUtils.ContentHashOnto(this.GoodArgument.dynamicKey, ref lastHash);
            }
