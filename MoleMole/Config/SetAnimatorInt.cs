namespace MoleMole.Config
{
    ...
    public class SetAnimatorInt : ConfigAbilityAction, IHashable
    {
        ...
        {
            object[] args = new object[] { Miscs.GetDebugActorName(instancedAbility.caster), Miscs.GetDebugActorName(target), this.IntID, this.Value };
        ...
        {
            HashUtils.ContentHashOnto(this.IntID, ref lastHash);
