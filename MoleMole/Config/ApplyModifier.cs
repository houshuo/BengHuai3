namespace MoleMole.Config
{
    ...
    public class ApplyModifier : ConfigAbilityAction, IHashable
    {
        ...
        {
            return new MPActorAbilityPlugin.MPAuthorityActionHandler(mpAbilityPlugin.ApplyModifier_AuthorityHandler);
        }

        public override MPActorAbilityPlugin.MPRemoteActionHandler MPGetRemoteHandler(MPActorAbilityPlugin mpAbilityPlugin)
        {
            return new MPActorAbilityPlugin.MPRemoteActionHandler(mpAbilityPlugin.ApplyModifier_RemoteHandler);
        }
